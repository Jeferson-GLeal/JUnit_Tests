package com.algaworks.junit.blog;
...
public class ArmazenamentoEditorFixoEmMemoria implements ArmazenamentoEditor {
    ...
    public Optional<Editor> encontrarPorEmail(String email) {
        if (email.equals("jeferson.leal@outlook.com")) {
            return Optional.of(new Editor(2L, "Jeferson", "jeferson.leal@outlook.com", BigDecimal.TEN, true));
        }
        return Optional.empty();
    }
